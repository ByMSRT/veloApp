...
public class VeloApplicationTI {
    ...
    public void save_get_station_return_station_success(){
        Stations station = Stations.builder().recordId("id").name("test").build();
        stationService.save(station);

        Optional<Stations> optionalStation = stationService.findByRecordId("id");
        assertNotNull(optionalStation);
        assertEquals("test", optionalStation.get().getName());
    }
